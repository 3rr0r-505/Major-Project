...
▶️ [Demo: HoneyPott3r Scan on a Conpot](https://youtu.be/OIiUPNZWTNE?si=XyPB1eRAnc_PCPh6)

## Installation

1. Clone this repository:
     ```
     git clone https://github.com/3rr0r-505/Major-Project.git
     ```
     ```
     cd Major-Project
     ```
...
## License
This project is licensed under the [MIT License](https://github.com/3rr0r-505/Major-Project/blob/main/LICENSE) - see the LICENSE file for details.
